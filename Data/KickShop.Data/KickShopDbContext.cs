...
namespace KickShop.Data
{
    public class KickShopDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        private void SeedDB(ModelBuilder builder)
        {
            ...
            {
                new Product { Name = "RDX Boxing Gloves", Description = "High-quality leather gloves for all training levels.", Price = 109.99m, StockQuantity = 100, BrandId = brands[1].BrandId, CategoryId = categories[0].CategoryId, Sizes = new List<Sizes> { Sizes.S, Sizes.M, Sizes.L },MainImageUrl ="/images/Products/rdx-boxing-gloves/rdx-boxing-glove-3.png" },
                new Product { Name = "Hayabusa T3 Boxing Gloves", Description = "Top-notch gloves with exceptional durability.", Price = 189.99m, StockQuantity = 50, BrandId = brands[2].BrandId, CategoryId = categories[0].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L, Sizes.XL },MainImageUrl ="/images/Products/hayabusa-boxing-gloves/hayabusa-boxing-gloves-1.png" },
                new Product { Name = "Venum Challenger Gloves", Description = "Lightweight and designed for all skill levels.", Price = 89.99m, StockQuantity = 120, BrandId = brands[3].BrandId, CategoryId = categories[0].CategoryId, Sizes = new List<Sizes> { Sizes.S, Sizes.M, Sizes.L },MainImageUrl ="/images/Products/venum-challenger-gloves/venum-challenger-gloves-2.png" },
                new Product { Name = "Title Boxing Leather Bag Gloves", Description = "Durable leather gloves for heavy bag workouts.", Price = 79.99m, StockQuantity = 80,  BrandId = brands[5].BrandId, CategoryId = categories[0].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L },MainImageUrl ="/images/Products/title-boxing-bag/title-boxing-bag-1.png" },
                new Product { Name = "Century Martial Arts Kickboxing Shorts", Description = "Comfortable shorts designed for kickboxing.", Price = 79.99m, StockQuantity = 75,  BrandId = brands[7].BrandId, CategoryId = categories[1].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L, Sizes.XL },MainImageUrl ="/images/Products/century-kickboxing-shorts/century-kickboxing-shorts-1.png" },
                new Product { Name = "Sanabul Essential Shin Guards", Description = "High-quality shin guards for protection and mobility.", Price = 105.99m, StockQuantity = 90, BrandId = brands[8].BrandId, CategoryId = categories[2].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L, Sizes.XL },MainImageUrl ="/images/Products/sanabul-shin-guards/sanabul-shin-guards-1.png" },
                ...
                new Product { Name = "Ringside Punching Bag", Description = "Heavy-duty bag for all levels of training.", Price = 219.99m, StockQuantity = 40,  BrandId = brands[6].BrandId, CategoryId = categories[6].CategoryId, Sizes = new List<Sizes> { Sizes.L },MainImageUrl="/images/Products/ringside-punching-bag/ringside-punching-bag-1.png" },
                new Product { Name = "RDX Pro Boxing Shoes", Description = "Lightweight and supportive for agility in the ring.", Price = 109.99m, StockQuantity = 65,  BrandId = brands[1].BrandId, CategoryId = categories[8].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L, Sizes.XL },MainImageUrl ="/images/Products/rdx-boxing-shoes/rdx-boxing-shoes-1.png" },
                new Product { Name = "Venum Challenger Shin Guards", Description = "High-durability shin guards ideal for intense training.", Price = 105.99m, StockQuantity = 95,  BrandId = brands[3].BrandId, CategoryId = categories[2].CategoryId, Sizes = new List<Sizes> { Sizes.S, Sizes.M, Sizes.L },MainImageUrl ="/images/Products/venum-challenger-shin-guards/venum-challenger-shin-guards-1.png" },
                new Product { Name = "Fairtex Muay Thai Shorts", Description = "Premium Muay Thai shorts with authentic design.", Price = 84.99m, StockQuantity = 90,  BrandId = brands[4].BrandId, CategoryId = categories[1].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L, Sizes.XL },MainImageUrl ="/images/Products/fairtex-muay-thai-shorts/fairtex-muay-thai-shorts-1.png" },
                new Product { Name = "Title Boxing Double End Bag", Description = "Perfect for accuracy and reflex training.", Price = 99.99m, StockQuantity = 70,  BrandId = brands[5].BrandId, CategoryId = categories[6].CategoryId, Sizes = new List<Sizes> { Sizes.L },MainImageUrl ="/images/Products/title-boxing-gloves/title-boxing-gloves-1.png" },
                new Product { Name = "Everlast Pro Headgear", Description = "Full-protection headgear with durable padding.", Price = 89.99m, StockQuantity = 50,  BrandId = brands[0].BrandId, CategoryId = categories[4].CategoryId, Sizes = new List<Sizes> { Sizes.M, Sizes.L },MainImageUrl ="/images/Products/everlast-pro-headgear/everlast-headgear-1.png" }
            };
